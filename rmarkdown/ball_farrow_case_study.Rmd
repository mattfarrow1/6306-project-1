...
for (j in 1:iterations) {
  ...
  {
    classifications <-
      knn(train[, c(3, 4)], test[, c(3, 4)], train$style2, prob = TRUE, k = i)
...
Based on this look for 30 different k's, we see the optimum accuracy is at k=1. 
...
sd(SensHolder) / sqrt(100)
```
With k=1, our average accuracy performance with 100 random splits is only 0.52. Let's revisit to find a better k.
